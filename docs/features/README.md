...
|---|---|---|
| זום זמני בהחזקת מגע — התקרבות למחברת | 🟡 PR פתוח ([#70](https://github.com/eyalzur/learn-math/pull/70)), כיוון תוקן, ממתין לריוויו | [status](./notebook-hold-to-zoom/status.md) |
