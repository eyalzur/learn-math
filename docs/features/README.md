...
|---|---|---|
| זום זמני בהחזקת מגע — התקרבות למחברת | 🟡 PR פתוח ([#70](https://github.com/eyalzur/learn-math/pull/70)), תיקון באג-מגע ממתין לאימות חוזר | [status](./notebook-hold-to-zoom/status.md) |
